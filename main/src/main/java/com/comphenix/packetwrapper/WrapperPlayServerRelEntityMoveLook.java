...
extends AbstractPacket {
    ...
    public double getDx() {
        return (double)((Integer)this.handle.getIntegers().read(1)).intValue() / 4096.0;
    }
    ...
    public double getDy() {
        return (double)((Integer)this.handle.getIntegers().read(2)).intValue() / 4096.0;
    }
    ...
    public double getDz() {
        return (double)((Integer)this.handle.getIntegers().read(3)).intValue() / 4096.0;
    }

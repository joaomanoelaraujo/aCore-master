...
public class ItemUtils {
    ...
    public static boolean isUsable(Material mat) {
        ...
        return mat.isEdible() || mat == Material.POTION || mat == Material.MILK_BUCKET || mat == Material.BOW || VersionUtil.isCompatible(VersionUtil.VersionEnum.V1_8) && ItemUtils.isSword(mat);
    }

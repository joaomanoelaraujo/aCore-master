...
import me.joaomanoel.d4rkk.dev.replay.ItemUtils;
...
import me.joaomanoel.d4rkk.dev.replay.Recorder;
import me.joaomanoel.d4rkk.dev.replay.SerializableItemStack;
...
extends AbstractListener {
    ...
    public void onPickup(PlayerPickupItemEvent e) {
        ...
        if (this.recorder.getPlayers().contains(p.getName())) {
            ...
            Game<?> game = profile != null ? profile.getGame() : null;

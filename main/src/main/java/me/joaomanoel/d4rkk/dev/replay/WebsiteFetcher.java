...
import me.joaomanoel.d4rkk.dev.replay.Acceptor;
import me.joaomanoel.d4rkk.dev.replay.Consumer;
import me.joaomanoel.d4rkk.dev.replay.JsonClass;
...
public class WebsiteFetcher {
    ...
    private static final Map<String, String> webChache = new HashMap<String, String>();
    private static final Map<String, JsonClass> jsonCache = new HashMap<String, JsonClass>();

...
//                Core.getInstance().getLogger().info("Banco de dados inicializado com sucesso!");
            } catch (Exception e) {
//                Core.getInstance().getLogger().severe("Erro ao inicializar banco de dados: " + e.getMessage());
                e.printStackTrace();
            }
        }
        ItemConfig.loadData();

...
public class ShopCommand extends Commands {
   ...
   public void perform(CommandSender sender, String label, String[] args) {
      if (!(sender instanceof Player)) {
         ...
         click.setBold(true);
         click.setClickEvent(new ClickEvent(Action.OPEN_URL, EN_US.loja$link));
         click.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, TextComponent.fromLegacyText("§7Click here to open the shop.")));
         component.addExtra(click);
         BaseComponent[] var12 = TextComponent.fromLegacyText(" §eto open the server shop.\n ");
         var8 = var12.length;

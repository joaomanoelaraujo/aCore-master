...
import me.joaomanoel.d4rkk.dev.libraries.npclib.npc.skin.SkinPacketTracker;
import me.joaomanoel.d4rkk.dev.libraries.npclib.npc.skin.SkinnableEntity;
import me.joaomanoel.d4rkk.dev.nms.NMS;
import me.joaomanoel.d4rkk.dev.nms.v1_8_R3.network.EmptyNetHandler;
import me.joaomanoel.d4rkk.dev.nms.v1_8_R3.utils.PlayerNavigation;
import me.joaomanoel.d4rkk.dev.nms.v1_8_R3.utils.controllers.PlayerControllerJump;
import me.joaomanoel.d4rkk.dev.nms.v1_8_R3.utils.controllers.PlayerControllerLook;
import me.joaomanoel.d4rkk.dev.nms.v1_8_R3.utils.controllers.PlayerControllerMove;
...
public class EntityNPCPlayer extends EntityPlayer implements NPCHolder, SkinnableEntity {
  ...
  private final me.joaomanoel.d4rkk.dev.libraries.npclib.api.npc.NPC npc;
  ...
  public EntityNPCPlayer(MinecraftServer server, WorldServer world, GameProfile profile, PlayerInteractManager manager, me.joaomanoel.d4rkk.dev.libraries.npclib.api.npc.NPC npc) {
  ...
  protected void a(double d0, boolean flag, Block block, BlockPosition blockposition) {
    if (npc == null || !npc.data().get(me.joaomanoel.d4rkk.dev.libraries.npclib.api.npc.NPC.FLYABLE, false)) {
  ...
  public void t_() {
    ...
    if (!navigating && npc.data().get(me.joaomanoel.d4rkk.dev.libraries.npclib.api.npc.NPC.GRAVITY, false) && getBukkitEntity() != null && Utils.isLoaded(getBukkitEntity().getLocation())) {
      g(0, 0);
    }
  ...
  @Override
  public me.joaomanoel.d4rkk.dev.libraries.npclib.api.npc.NPC getNPC() {
    return npc;
  }

...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("me.joaomanoel.d4rkk.dev.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("me.joaomanoel.d4rkk.dev.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("me.joaomanoel.d4rkk.dev.player.Profile"), "findCached", String.class);

...
public class EntitySlime extends EntitySlime implements ISlime {
  
  private final HologramLine line;
  
  public EntitySlime(Location world, HologramLine line) {
    super(world);
  ...
  public net.minecraft.world.entity.Entity getBukkitEntity() {

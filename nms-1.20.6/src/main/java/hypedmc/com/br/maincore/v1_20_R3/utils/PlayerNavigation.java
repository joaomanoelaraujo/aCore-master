...
import hypedmc.com.br.maincore.v1_20_R3.entity.EntityNPCPlayer;
...
public class PlayerNavigation extends NavigationAbstract {
  ...
  private final PathfinderNormal s;
  ...
  public PlayerNavigation(EntityNPCPlayer entityinsentient, World world) {
    ...
    this.a.setValue(24); // Range de 24 blocos

    this.s = new PathfinderNormal();
    this.s.a(true); // Ativa a movimentação normal
    this.j = new Pathfinder(this.s);
  }
